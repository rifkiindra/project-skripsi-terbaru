...
<div class="card">
    <div class="card-header">
        <a href="{{ route('admin.artworks.create') }}" class="btn btn-primary float-right">
            ...
            <tbody>
                ...
                <div class="modal fade" id="imageModal{{ $artwork->id }}" tabindex="-1">
                    ...
                    <tr>
                        ...
                        <td>
                            @if(
                                ($artwork->status === 'sketsa' && $artwork->sketsa_image) ||
                                ($artwork->status === 'color' && $artwork->color_image) ||
                                ($artwork->status === 'final' && $artwork->final_image)
                                )
