<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            placeholder="Contoh : Jl. Palagan Tentara Pelajar, Kabupaten Sleman">{{ old('alamat') }}</textarea>
            <x-input-error :messages="$errors->get('alamat')" class="mt-2" />
        </div>

         <!-- phone -->
        <div class="mt-4">
           <x-input-label for="telepon" :value="__('Phone Number')" class="text-white" />
           <x-text-input id="telepon" class="block mt-1 w-full" type="text"
           name="telepon" :value="old('telepon')" required autocomplete="tel" 
