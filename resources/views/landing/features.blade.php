...
<section class="works-section">
    ...
    <div class="work-preview">
        <img id="preview-image" src="{{ asset('landing/images/Call for Backup.jpg') }}" alt="preview">
    </div>

    <!-- TEXT CENTERED -->
    <div class="work-list">

        <div class="work-item" data-image="{{ asset('landing/images/Call for Backup.jpg') }}"
